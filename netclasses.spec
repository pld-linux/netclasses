...
netclasses to biblioteka do komunikacji asynchronicznej działająca
natywnie na OS X oraz wielu platformach obsługiwanych przez GNUstepa.
Wg autorów nie ma łatwiejszej metody łączenia aplikacji sieciowych.
...
Pliki nagłówkowe biblioteki netclasses.
